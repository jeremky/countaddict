...
const TRANSLATIONS = {
  fr: {
    ...
    catalog: {
      ...
      chocolate: { label: "Chocolat", addLabel: "Ajouter un chocolat", removeLabel: "Retirer un chocolat" },
  ...
  en: {
    ...
    catalog: {
      ...
      chocolate: { label: "Chocolate", addLabel: "Add a chocolate", removeLabel: "Remove a chocolate" },
